...
class BWBSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class BWBExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(BWBDateTimeConverter converter)
    {
        if(converter==null)
        {
            converter = new BWBStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static BWBDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static BWBDateTimeConverter dateTimeConverter = new BWBStandardDateTimeConverter();

    public BWBExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public BWBExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new BWBMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=BWBHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,BWBExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=BWBHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
