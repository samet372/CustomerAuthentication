...
public class WEMKPSPublicSoap12
{
    interface WEMIWcfMethod
    {
        WEMExtendedSoapSerializationEnvelope CreateSoapEnvelope() throws java.lang.Exception;

        java.lang.Object ProcessResult(WEMExtendedSoapSerializationEnvelope __envelope,java.lang.Object result) throws java.lang.Exception;
    }
    ...
    public WEMKPSPublicSoap12(){}

    public WEMKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public WEMKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    protected WEMExtendedSoapSerializationEnvelope createEnvelope()
    {
        WEMExtendedSoapSerializationEnvelope envelope= new WEMExtendedSoapSerializationEnvelope(WEMExtendedSoapSerializationEnvelope.VER12);
    ...
    protected java.util.List sendRequest(String methodName,WEMExtendedSoapSerializationEnvelope envelope,org.ksoap2.transport.Transport transport ,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile )throws java.lang.Exception
    {
    ...
    java.lang.Object getResult(java.lang.Class destObj,java.lang.Object source,String resultName,WEMExtendedSoapSerializationEnvelope __envelope) throws java.lang.Exception
    {
        if(source==null)
        {
            return null;
    ...
    public Boolean TCKimlikNoDogrula(final Long TCKimlikNo,final String Ad,final String Soyad,final Integer DogumYili) throws java.lang.Exception
    {
        ...
        return (Boolean)execute(new WEMIWcfMethod()
        {
            @Override
            public WEMExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                WEMExtendedSoapSerializationEnvelope __envelope = createEnvelope();
            ...
            @Override
            public java.lang.Object ProcessResult(WEMExtendedSoapSerializationEnvelope __envelope,java.lang.Object __result)throws java.lang.Exception {
    ...
    protected java.lang.Object execute(WEMIWcfMethod wcfMethod,String methodName,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws java.lang.Exception
    {
        org.ksoap2.transport.Transport __httpTransport=createTransport();
        __httpTransport.debug=enableLogging;
        WEMExtendedSoapSerializationEnvelope __envelope=wcfMethod.CreateSoapEnvelope();
        try
        {
    ...
    protected java.lang.Exception convertToException(org.ksoap2.SoapFault fault,WEMExtendedSoapSerializationEnvelope envelope)
    {
