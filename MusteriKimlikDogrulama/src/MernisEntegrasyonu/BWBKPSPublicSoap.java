...
public class BWBKPSPublicSoap
{
    ...
    public BWBKPSPublicSoap(){}

    public BWBKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public BWBKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        BWBExtendedSoapSerializationEnvelope envelope= new BWBExtendedSoapSerializationEnvelope(BWBExtendedSoapSerializationEnvelope.VER11);
