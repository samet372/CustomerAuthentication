...
public class BWBKPSPublicSoap12
{
    interface BWBIWcfMethod
    {
        BWBExtendedSoapSerializationEnvelope CreateSoapEnvelope() throws java.lang.Exception;

        java.lang.Object ProcessResult(BWBExtendedSoapSerializationEnvelope __envelope,java.lang.Object result) throws java.lang.Exception;
    }
    ...
    public BWBKPSPublicSoap12(){}

    public BWBKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public BWBKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    protected BWBExtendedSoapSerializationEnvelope createEnvelope()
    {
        BWBExtendedSoapSerializationEnvelope envelope= new BWBExtendedSoapSerializationEnvelope(BWBExtendedSoapSerializationEnvelope.VER12);
    ...
    protected java.util.List sendRequest(String methodName,BWBExtendedSoapSerializationEnvelope envelope,org.ksoap2.transport.Transport transport ,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile )throws java.lang.Exception
    {
    ...
    java.lang.Object getResult(java.lang.Class destObj,java.lang.Object source,String resultName,BWBExtendedSoapSerializationEnvelope __envelope) throws java.lang.Exception
    {
        if(source==null)
        {
            return null;
    ...
    public Boolean TCKimlikNoDogrula(final Long TCKimlikNo,final String Ad,final String Soyad,final Integer DogumYili) throws java.lang.Exception
    {
        ...
        return (Boolean)execute(new BWBIWcfMethod()
        {
            @Override
            public BWBExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                BWBExtendedSoapSerializationEnvelope __envelope = createEnvelope();
            ...
            @Override
            public java.lang.Object ProcessResult(BWBExtendedSoapSerializationEnvelope __envelope,java.lang.Object __result)throws java.lang.Exception {
    ...
    protected java.lang.Object execute(BWBIWcfMethod wcfMethod,String methodName,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws java.lang.Exception
    {
        org.ksoap2.transport.Transport __httpTransport=createTransport();
        __httpTransport.debug=enableLogging;
        BWBExtendedSoapSerializationEnvelope __envelope=wcfMethod.CreateSoapEnvelope();
        try
        {
    ...
    protected java.lang.Exception convertToException(org.ksoap2.SoapFault fault,BWBExtendedSoapSerializationEnvelope envelope)
    {
