...
public class WEMKPSPublicSoap
{
    ...
    public WEMKPSPublicSoap(){}

    public WEMKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public WEMKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        WEMExtendedSoapSerializationEnvelope envelope= new WEMExtendedSoapSerializationEnvelope(WEMExtendedSoapSerializationEnvelope.VER11);
