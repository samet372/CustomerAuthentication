...
class WEMSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class WEMExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(WEMDateTimeConverter converter)
    {
        if(converter==null)
        {
            converter = new WEMStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static WEMDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static WEMDateTimeConverter dateTimeConverter = new WEMStandardDateTimeConverter();

    public WEMExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public WEMExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new WEMMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=WEMHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,WEMExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=WEMHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
